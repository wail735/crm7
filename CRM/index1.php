...
<body class="bg-gray-100">
    <div class="container mx-auto my-8 px-4">
        ...
        <a class="btn btn-info mr-2 py-1 px-2 rounded-md bg-blue-500 text-white hover:bg-blue-600 mb-4 inline-block" href="/CRM/creat.php" role="button">Créer un client</a>
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo '<a class="btn btn-danger py-1 px-2 rounded-md bg-red-500 text-white hover:bg-red-600" href="/CRM/delete.php?id=' . $row["id"] . '">Supprimer</a>';                            echo '</div>';
                            echo "</td>";
                            echo "</tr>";
                        }
                    } else {
